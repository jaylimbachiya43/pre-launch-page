    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center  h-screen">
        ...
        {!showContent && (
          <>
            <div
              className={` border border-black max-w-4xl rounded-3xl shadow-black shadow-lg overflow-hidden  mx-2 md:mx-6  lg:mx-10 md:my-10 ${
                showContent ? "animate" : ""
              }`}
            >
              <video
    ...
    <p className="text-lg font-semibold md:text-base ">
      Subscribe to our newsletter for upcoming updates and exclusive insights!
              ...
              <div className=" flex flex-col md:flex-row gap-2 justify-center content-center items-center  md:mt-9">
                ...
                />
                <button className=" py-3 px-8 rounded-full bg-gradient-to-r from-yellow-500 to-yellow-800 text-white text-sm font-medium outline-none cursor-pointer">
                  Subscribe
                </button>
              </div>
            </div>
